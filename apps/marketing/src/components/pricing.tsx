    ...
    <section id="pricing" aria-labelledby="pricing-heading" className="bg-paper py-20 sm:py-28">
      <div className={container}>
        ...
        <p className="mt-6 flex justify-center">
          <span className="inline-flex items-center gap-2 rounded-full bg-primary-soft px-3 py-1 text-xs font-semibold text-primary-dark">
          ...
          {copy.plans.map((plan) => {
            ...
            return (
              <li
                ...
                className="relative flex flex-col overflow-hidden rounded-3xl border border-line bg-paper-raised p-6 shadow-card sm:p-8"
              >
                {plan.id === "growth" ? (
                  <span
                    aria-hidden
                    className="absolute inset-x-0 top-0 h-1 bg-linear-to-r from-zimos-blue to-zimos-sky rtl:bg-linear-to-l"
                  />
                ) : null}
