...
export const btnPrimary =
  "inline-flex items-center justify-center gap-2 rounded-lg bg-zimos-blue font-semibold text-white transition-colors duration-200 hover:bg-[#0052d6] active:bg-[#0044b3]";
