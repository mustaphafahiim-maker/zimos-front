...
export function StepBasics({ state, next, update, setSaving, saving, formId, initialName }: StepProps & { initialName?: string }) {
  ...
  async function handleSubmit(e: FormEvent) {
    ...
    try {
      ...
      // `slug` is accepted by PATCH /workspaces/:id (workspaceValidation.updateWorkspace)
      // but not yet declared on the shared client type, which this task must not edit.
      const payload: UpdateWorkspacePayload & { slug?: string } = {};
