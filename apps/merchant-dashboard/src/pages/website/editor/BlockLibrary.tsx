...
import { editorUi, groupLabel, presetText, useEditorLocale } from "./editorLocale";
                ...
                {presets.map((preset) => {
                  ...
                  return (
                    <button
                      ...
                      className="cursor-pointer group flex w-full items-center gap-2 rounded-[0.5rem] px-2 py-2 text-start text-sm text-ink transition-colors hover:bg-paper focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/40"
                    >
