...
const PRESET_AR: Record<string, { label: string; description: string }> = {
  ...
  multirow: {
    label: "قصة متبادلة",
    description: "خطوتين أو تلاتة، صورة وكلام في كل واحدة، بالتبادل — إزاي بيتصنّع، أو إزاي بيشتغل، خطوة خطوة.",
  },
  "related-products": {
    label: "منتجات تانية تعجبك",
    description: "صف صغير تحت المحتوى الأساسي — منتجات مشابهة يشوفها العميل.",
  },
  "newsletter-banner": {
    label: "نشرة بريدية بصورة",
    description: "نفس الدعوة للاشتراك، جنب صورة بدل ما تكون في النص لوحدها.",
  },
  "rich-text-band": {
    label: "شريط نص طويل",
