 ...
 * This is a local copy of the same component the marketing, storefront and dashboard apps
 * carry — the raster assets are served per-app out of `public/`, so the
 * component lives beside them rather than in `@store-builder/ui`. Keep the
 * markup and class names in sync with the other copies.
 *
