  ...
  return (
    <div>
      ...
      <div className="mb-4 grid grid-cols-1 gap-3 sm:grid-cols-2 xl:grid-cols-4">
        {ADMIN_ROLES.map((r) => (
          <div key={r.value} className="rounded-[var(--radius-card)] border border-line bg-paper-raised px-4 py-3">
                    ...
                    <TableRow key={u.id} className={cn(u.status === "disabled" && "opacity-60")}>
                      <Td>
                        <div className="flex items-center gap-3">
                          <span className="flex size-8 shrink-0 items-center justify-center rounded-full bg-primary-dark dark:bg-primary-soft text-xs font-semibold text-white" aria-hidden>
                            {initials(u.name)}
                          </span>
                          <div>
            ...
            {ADMIN_ROLES.map((r) => (
              <label
                ...
                className={cn(
                  ...
                  role === r.value ? "border-primary bg-primary-soft" : "border-line hover:border-ink-soft"
                )}
              >
