                  ...
                  <li key={m.id} className={cn("flex gap-3", mine && "flex-row-reverse")}>
                    <span
                      className={cn(
                        ...
                        mine ? "bg-primary-dark dark:bg-primary-soft text-white" : "bg-primary-soft text-primary"
                      )}
                      aria-hidden
                    >
                    ...
                    <div className={cn("max-w-[85%] min-w-0", mine && "text-end")}>
                      ...
                      <div
                        className={cn(
                          ...
                          m.internal ? "border-accent/30 bg-accent-soft" : mine ? "border-primary/20 bg-primary-soft" : "border-line bg-paper"
                        )}
                      >
                        {m.internal && (
                          <span className="mb-1 flex items-center gap-1 text-xs font-semibold text-accent-dark">
          ...
          <Panel title={internal ? "Add internal note" : "Reply"}>
            <form onSubmit={send} className="space-y-3">
              <Textarea
                ...
                aria-label="Message"
                className={cn("min-h-28", internal && "border-accent/40 bg-accent-soft/50")}
              />
